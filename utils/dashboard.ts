...
import type { BreakdownDimension, BreakdownMetric, TradeTooltipField } from '~/type'
...
export const formatDimensionLabel = (dimension: BreakdownDimension, key: string, translate: (key: string) => string): string => {
