...
$content = $content -replace 'postgresPassword1234', $POSTGRES_PASSWORD
...
# Ajouter les URLs PostgreSQL
$newLines += ""
$newLines += "# PostgreSQL URLs (Prisma requiert des URLs complètes)"
$newLines += "POSTGRES_URL_AUTH=postgresql://pnltracker:${POSTGRES_PASSWORD}@localhost:5432/pnltracker?schema=public"
$newLines += "POSTGRES_URL_TEMPLATE=postgresql://pnltracker:${POSTGRES_PASSWORD}@localhost:5432/pnltracker"
