...
export const createAppError = (params: AppErrorParams): AppError => {
	...
	const appError = new Error(finalMessage) as AppError;
	appError.statusCode = rest.statusCode || 500;
	appError.statusMessage = finalMessage;
	appError.data = enhancedData;
	return appError;
}