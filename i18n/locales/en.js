    ...
    components: {
        ...
        dashboard: {
            ...
            all_trades: {
                ...
                avg_trade_time: 'Avg. Trade Time',
                longest_trade_time: 'Longest Trade Time',
            ...
            losing_trades: {
                ...
                losing_contracts: '# of Losing Contracts',
                largest_loss: 'Largest Losing Trade',
                avg_loss: 'Avg. Losing Trade',
                std_dev: 'Std. Dev. Losing Trade',
                avg_loss_time: 'Avg. Losing Trade Time',
        ...
        import: {
            ...
            profile_execute: {
                api_info: 'This import uses a live API connection.',
                ibkr_api_desc: 'The Flex Query will be executed with the token and query ID configured in this profile.',
                nt8_api_desc: 'NinjaTrader addon must be installed and running.',
            },
        },
        screenshot: {
            manager: {
