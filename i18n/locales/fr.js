export default {
    ...
    components: {
        ...
        import: {
            ...
            profile_execute: {
                api_info: 'Cet import utilise une connexion API en direct.',
                ibkr_api_desc: 'La Flex Query sera exécutée avec le token et le query ID configurés dans ce profil.',
                nt8_api_desc: "L'addon NinjaTrader doit être installé et en cours d'exécution.",
            },
        },
        screenshot: {
            manager: {
