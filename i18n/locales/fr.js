export default {
    ...
    pages: {
        index: {
            ...
            feature_organization: 'Organisation par symbole, type et tags',
            feature_screenshots: 'Captures d\'écran et notes sur les trades',
            feature_calendar: 'Calendrier de trading interactif',
            feature_plugins: 'Plugins personnalisables et convertisseurs',
            feature_multi: 'Multi-comptes et multi-bases de données',
        ...
        login: {
            ...
            reset_local_data: 'Réinitialiser les données à la prochaine connexion',
        ...
        select_database: {
            ...
            backup_restore_all: 'Sauvegarder / Restaurer toutes les bases',
        ...
        backup_restore: {
            title: 'Sauvegarder / Restaurer toutes les bases',
            back: 'Retour',
            ...
            export_partial: '{success}/{total} base(s) exportée(s)',
            export_failed: "Échec de l'export",
            no_databases: 'Aucune base de données trouvée',
            backup_dir: 'Répertoire de sauvegarde',
            no_backup_dir: 'Répertoire de sauvegarde non configuré',
            no_backup_dir_desc: 'Configurez un répertoire de sauvegarde dans l\'onglet Paramètres d\'abord.',
            import_section: 'Importer',
            import_description: 'Scannez le répertoire de sauvegarde configuré pour trouver des fichiers de sauvegarde (.zip) et les restaurer. Les bases existantes avec le même nom seront remplacées.',
            import_button: 'Restaurer les bases',
            import_scan: 'Scanner le répertoire',
            import_scan_error: 'Échec du scan du répertoire de sauvegarde',
            import_progress: 'Restauration de la base {current}/{total}...',
            import_confirm_title: 'Confirmation',
            import_confirm_message: 'Les bases de données existantes avec le même nom seront remplacées. Voulez-vous continuer ?',
            import_replace_warning: '{count} base(s) seront remplacée(s)',
            import_success: '{count} base(s) restaurée(s)',
            import_partial: '{success}/{total} base(s) restaurée(s)',
            import_failed: 'Échec de la restauration',
            import_will_replace: 'Sera remplacée',
            import_new_db: 'Nouvelle base',
            no_zip_files: 'Aucun fichier de sauvegarde trouvé dans le répertoire',
            settings_section: 'Paramètres',
            settings_description: 'Configurez le répertoire utilisé pour l\'export et l\'import des sauvegardes.',
            settings_tab: 'Configurer',
            settings_saved: 'Paramètres enregistrés avec succès',
            settings_save_error: 'Échec de l\'enregistrement des paramètres',
            backup_dir_placeholder: 'Sélectionner un répertoire de sauvegarde',
            backup_dir_help: 'Les sauvegardes seront exportées et importées depuis ce répertoire.',
            browse: 'Parcourir',
            enter_dir_path: 'Saisissez le chemin du répertoire :',
        },
    },
    components: {
        notes_panel: {
        ...
        dashboard: {
            common: {
                ...
                show_threshold: 'Afficher le seuil de capital initial',
                max_trades: 'Trades maximum',
                bar_color_info: "Métriques monétaires (P&L, APPT, etc.) : vert/rouge. Pourcentages et ratios (winrate, profit factor) : couleur ci-dessus. Métriques brutes (durée, compteur) : couleur brute ci-dessus. La couleur MA s'applique à la moyenne mobile.",
                crosshair: 'Réticule',
                crosshair_cross: 'Croix (horizontal + vertical)',
                crosshair_line: 'Ligne verticale uniquement',
            },
            visibility: {
                title: 'Graphiques',
                charts: 'Graphiques',
                ...
                templates_breakdown: 'Répartition',
                templates_breakdown_bars: 'Barres',
                templates_breakdown_scatter_heatmap: 'Nuage & Heatmap',
            ...
            charts: {
                ...
                breakdown_bar_vertical: 'Graphique Barres Verticales - Répartition',
                breakdown_scatter: 'Graphique Nuage - Répartition',
                breakdown_scatter_2d: 'Nuage 2D - Corrélation',
                breakdown_table: 'Tableau - Répartition',
                breakdown_heatmap: 'Heatmap - Répartition',
                breakdown_boxplot: 'Boxplot - Distribution',
                breakdown_calendar: 'Heatmap Calendrier',
                breakdown_radar: 'Radar - Performance',
                hourly_heatmap: 'Heatmap Heure × Jour',
                hourly_winrate: 'Taux de Gain (wr) par heure',
                day_of_week_pnl: 'PnL moyen par jour de semaine',
            },
            // Templates de charts (raccourcis pré-configurés)
            templates: {
                pnl_by_ticker: 'PnL par Ticker',
                winrate_by_ticker: 'Taux de Gain par Ticker',
                pnl_by_day_of_week: 'PnL par jour de semaine',
                winrate_by_hour: 'Taux de Gain par heure',
                pnl_by_month: 'PnL par mois',
                pnl_by_month_year: 'PnL par mois et année',
                heatmap_hour_day: 'Heatmap Heure × Jour',
                pnl_distribution_by_ticker: 'Distribution P&L par Ticker',
                pnl_calendar: 'Calendrier P&L',
                winrate_vs_profit_factor: 'Taux de Gain vs Profit Factor',
                avg_win_vs_avg_loss: 'Gain Moyen vs Perte Moyenne',
                pnl_vs_drawdown: 'P&L vs Drawdown',
                duration_vs_pnl: 'Durée vs P&L',
                performance_radar: 'Radar de Performance',
                pnl_by_trade: 'P&L par Trade',
                cumulated_pnl: 'P&L Cumulé',
                appt: 'APPT',
                winrate: 'Taux de Gain',
                custom_bar: 'Barres horizontales',
                custom_bar_vertical: 'Barres verticales',
                custom_scatter: 'Nuage',
                custom_table: 'Tableau',
                custom_bar_ma: 'Barres + MA',
                custom_area_chart: 'Area chart',
                custom_bar_by_trade: 'Barres par Trade',
            },
            ...
            breakdown: {
                ...
                metric: 'Métrique',
                color: 'Couleur',
                percentile_range: 'Plage',
                scroll_x: 'Scroll X',
                scroll_y: 'Scroll Y',
                show_labels: 'Étiquettes',
                log_scale: 'Log',
                ticker_filter: 'Ticker',
                all_tickers: 'Tous les tickers',
                trade_property: {
                    duration: 'Durée',
                    pnl: 'P&L',
                    mfe: 'MFE',
                ...
                dimensions: {
                    ...
                    tag: 'Tag',
                    side: 'Type',
                    monthOpen: 'Mois (Ouverture)',
                    monthClose: 'Mois (Clôture)',
                    monthYearOpen: 'Mois et Année (Ouverture)',
                    monthYearClose: 'Mois et Année (Clôture)',
                    dayOfWeekOpen: 'Jour de semaine (Ouverture)',
                    dayOfWeekClose: 'Jour de semaine (Clôture)',
                    hourStart: 'Heure d\'ouverture',
                    hourEnd: 'Heure de clôture',
                    hourDayOfWeek: 'Heure × Jour de semaine',
                },
                metrics: {
                    pnl: 'P&L',
                    winrate: 'Taux de Gain (wr)',
        ...
        settings: {
            ...
            options: {
                ...
                data_sync_section: 'Synchronisation des données',
                save_ui_state: 'Sauvegarder l\'interface',
                save_ui_state_button: 'Sauvegarder maintenant',
                save_ui_state_desc: 'Sauvegardez vos filtres, paramètres de graphiques et préférences sur le serveur. Ils seront restaurés à votre prochaine connexion, même depuis un autre navigateur.',
                save_ui_state_success: 'État de l\'interface sauvegardé avec succès',
                save_ui_state_error: 'Échec de la sauvegarde de l\'état de l\'interface',
                reset_ui_state: 'Réinitialiser les données locales',
                reset_ui_state_button: 'Réinitialiser',
                reset_ui_state_desc: 'Effacer toutes les données locales (filtres, paramètres de graphiques, préférences) de ce navigateur. L\'état vide sera synchronisé vers le serveur à la fermeture.',
                reset_ui_state_success: 'Données locales réinitialisées avec succès',
                reset_ui_state_error: 'Échec de la réinitialisation des données locales',
                ...
                polygon_request_delay_desc: 'Délai minimum entre les requêtes API Polygon (plan gratuit : 12000ms).',
                polygon_max_retries: 'Retry max',
                polygon_max_retries_desc: 'Nombre maximum de tentatives en cas de rate limit (429).',
                polygon_cache_refresh: 'Refresh cache (min)',
                polygon_cache_refresh_desc: 'Délai avant de re-fetcher les données du mois en cours (défaut : 1440 = 24h).',
                ...
                rth_sessions: 'Heures de session régulières (RTH)',
                rth_sessions_desc: "Horaires de session RTH par type d'instrument. Les bougies hors de ces plages sont masquées quand \"RTH uniquement\" est coché. Le forex et les crypto n'ont pas de RTH (quasi 24/7).",
                rth_open: 'Ouverture',
                rth_close: 'Fermeture',
                rth_timezone: 'Fuseau horaire',
                rth_type_stock: 'Actions',
                rth_type_future: 'Futures',
                rth_type_option: 'Options',
                rth_type_any: 'Indéterminé',
                ...
                chart_time_series: 'Graphique Série Temporelle',
                color_bar: 'Couleur des barres',
                color_percent_metric: 'Couleur des pourcentages et ratios (winrate, profit factor)',
                color_point: 'Couleur de la ligne',
                color_moving_average: 'Couleur de la moyenne mobile',
                color_raw_metric: 'Couleur des métriques brutes (durée, nombre de trades)',
                chart_heatmap: 'Heatmap',
                color_heatmap_min: 'Couleur minimale',
                color_heatmap_max: 'Couleur maximale',
                chart_scatter_2d: 'Nuage 2D',
                color_scatter_2d_min: 'Couleur minimale',
                color_scatter_2d_mid: 'Couleur intermédiaire',
                color_scatter_2d_max: 'Couleur maximale',
            ...
            security: {
                title: 'Sécurité',
                description: 'Mettez à jour votre adresse e-mail et votre mot de passe.',
                ...
                update_success: 'Paramètres de sécurité mis à jour avec succès',
                update_error: 'Échec de la mise à jour des paramètres de sécurité',
        ...
        trade: {
            ...
            formModal: {
                ...
                riskReward: {
                    label: 'R/R',
                    help: 'Ratio risque/rendement pour ce trade',
                    placeholder: 'ex: 2',
                    calc_button: 'Calculer le R/R',
                    clear_button: 'Effacer le R/R',
                },
                screenshots: {
        ...
        daily: {
            ...
            trade_group: {
                ...
                activate_button: 'Activer',
                deactivate_button: 'Désactiver',
                edit_trade_button: 'Éditer le trade',
                edit_button: 'Éditer',
        ...
        calendar: {
            index: {
                ...
                total: 'Total',
                no_trades_for_day: 'Aucun trade pour ce jour',
                no_trades_for_week: 'Aucun trade pour cette semaine',
            },
        },
    },
    api: {
