    ...
    components: {
        ...
        dashboard: {
            ...
            visibility: {
                ...
                breakdown_charts: 'Répartitions',
                breakdown_hint: 'Cliquez sur + pour créer un nouveau widget de répartition. Configurez la dimension et la métrique dans l\u2019en-tête du widget. Fermez le widget avec la croix en haut à droite.',
            ...
            charts: {
                ...
                breakdown_bar: 'Graphique Barres - Répartition',
                breakdown_scatter: 'Graphique Nuage - Répartition',
                breakdown_table: 'Tableau - Répartition',
                hourly_heatmap: 'Heatmap Heure × Jour',
                hourly_winrate: 'Taux de Gain (wr) par heure',
                day_of_week_pnl: 'PnL moyen par jour de semaine',
            },
            // Labels du widget breakdown configurable
            breakdown: {
                dimension: 'Dimension',
                metric: 'Métrique',
                columns: 'Colonnes',
                ...
                all: 'Tous',
                by: 'par',
                table_title: 'Détail par',
                empty_state: 'Aucune donnée',
                tooltip_metrics: 'Métriques dans l\'info-bulle',
                dimensions: {
                    ticker: 'Ticker',
                    tag: 'Tag',
                    side: 'Type',
                    month: 'Mois',
                    monthYear: 'Mois et Année',
                    dayOfWeek: 'Jour de semaine',
                    hourStart: 'Heure d\'ouverture',
                    hourEnd: 'Heure de clôture',
                },
                metrics: {
                    pnl: 'P&L',
                    winrate: 'Taux de Gain (wr)',
            ...
            day_statistics: {
                ...
                largest_profitable_day_pnl: 'Meilleur jour P&L',
                largest_profitable_day_date: 'Date du meilleur jour',
                largest_losing_day_pnl: 'Pire jour P&L',
                largest_losing_day_date: 'Date du pire jour',
                daily_max_drawdown: 'Max Drawdown journalier',
        ...
        settings: {
            ...
            options: {
                ...
                show_trade_chart: 'Afficher le graphique dans le détail',
                show_trade_chart_desc: 'Affiche le graphique de prix dans la fenêtre de détail du trade.',
                trade_detail_section: 'Détail du trade',
                show_detailed_note: 'Afficher les notes détaillées',
                show_detailed_note_desc: 'Affiche les notes détaillées dans la fenêtre de détail du trade.',
                polygon_api_key: 'Clé API Polygon',
                polygon_api_key_desc: 'Clé API pour récupérer les données de prix (graphique de trade). Laisser vide pour désactiver.',
                polygon_cache: 'Cache Polygon',
                polygon_cache_clear: 'Vider le cache',
                polygon_cache_desc: 'Supprime toutes les données de prix mises en cache localement.',
                polygon_cache_cleared: 'Cache Polygon vidé',
        ...
        trade: {
            chart: {
                ...
                no_symbol: 'Aucun symbole Polygon configuré pour ce trade',
                range_too_large: 'La durée du trade est trop longue pour cette timeframe. Essayez une timeframe plus élevée.',
