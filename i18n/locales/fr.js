    ...
    components: {
        ...
        dashboard: {
            common: {
                ...
                bar_color_info: "Couleur des barres : vert/rouge pour les métriques négatives (P&L, APPT, etc.), couleur personnalisée pour les autres. La couleur MA s'applique à la moyenne mobile.",
                crosshair: 'Réticule',
