...
const rows = computed<StatsRow[]>(() => [
	...
	{ label: 'components.dashboard.day_statistics.largest_profitable_day_date', value: result.value.largestProfitableDayDate, format: 'dateOnly', condition: !!result.value.largestProfitableDayDate } satisfies StatsRow,
	...
	{ label: 'components.dashboard.day_statistics.largest_losing_day_date', value: result.value.largestLosingDayDate, format: 'dateOnly', condition: !!result.value.largestLosingDayDate } satisfies StatsRow,
