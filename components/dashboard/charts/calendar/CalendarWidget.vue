	...
	return {
		...
		calendar: {
			...
			dayLabel: {
				...
				fontSize: 10,
				nameMap: [
					t('common.weekdays.narrow.sunday'),
					t('common.weekdays.narrow.monday'),
					t('common.weekdays.narrow.tuesday'),
					t('common.weekdays.narrow.wednesday'),
					t('common.weekdays.narrow.thursday'),
					t('common.weekdays.narrow.friday'),
					t('common.weekdays.narrow.saturday'),
				],
			},
